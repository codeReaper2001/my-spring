...
import com.demo.springframework.context.ConfigurableApplicationContext;
import com.demo.springframework.context.event.ApplicationEventMulticaster;
import com.demo.springframework.context.event.ContextClosedEvent;
import com.demo.springframework.context.event.ContextRefreshedEvent;
import com.demo.springframework.context.event.SimpleApplicationEventMulticaster;
...
public abstract class AbstractApplicationContext
    ...
    public void refresh() throws BeansException {
        ...
        // 4.在Bean实例化前，执行 BeanFactoryPostProcessor (Invoke factory processors registered as beans in the context.)
